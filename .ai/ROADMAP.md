...
**Exact next step:** re-run CI green on the fix head → record the run IDs here → PR #71 review + merge decision (do **not** merge until asked). ADR-007 (#54) and #53 (do-not-merge ROADMAP wipe) are unchanged.
