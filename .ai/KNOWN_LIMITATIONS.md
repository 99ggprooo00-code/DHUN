...
- **Gate:** S1 remains RED/open; S2 is blocked and PR #91 remains open/unmerged. The first narrow tokenless parser candidate was CI-verified at `005b526`, but owner run **35308796439** still failed `home-more` with a top-level `contents` response. A follow-up direct-contents candidate is now under CI with synthetic coverage; it is not live-validated. No cookies, sign-in, PO tokens, BotGuard, attestation, or ADR-007 were added. The sandbox has no JDK, so local Kotlin/Gradle tests remain unrun.
