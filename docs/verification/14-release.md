...
> Follow-up head `526e390` is PR-green (CI **35309128614**, Build APK **35309128640**, test-release **35309128612**). Independent push CI **35309124090** flaked on an unrelated `LibraryViewModelTest` timeout; this does not establish a parser failure, but a green push check is still required for a clean branch.
