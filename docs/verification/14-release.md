...
> **Current status (2026-09-18, Stage S1 remains open):** The release baseline remains `main@33e94b0` after PR #90. PR #91 is OPEN and unmerged at **`c71d1bb`**; Android and Windows/Desktop production fixes remain intact and are not the remaining issue.
