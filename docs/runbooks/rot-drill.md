...
- **Follow-up CI:** head `526e390` is PR-green, but push CI **35309124090** hit an unrelated `LibraryViewModelTest` timeout. Wait for a clean push check before the next candidate-branch probe; do not reinterpret that timeout as extraction or parser evidence.
